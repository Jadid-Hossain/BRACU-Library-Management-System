...
export default function ResearchHelpSubmitPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => {
        router.push("/research-help/success");
      }, 1000);
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-white py-12">
      <div className="max-w-3xl mx-auto px-4">
        <div className="mb-6">
          <Link href="/research-help" className="text-blue-600 hover:text-blue-800">
            &larr; Back to Research Help
          </Link>
        </div>
        ...
        {success ? (
          <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded mb-6">
            Your request has been successfully submitted! Redirecting...
          </div>
        ) : (
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  We'll send our research assistance to this email
                </p>
              </div>
